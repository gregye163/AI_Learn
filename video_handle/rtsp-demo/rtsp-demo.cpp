...
//const string ipcUrl="rtsp://192.168.1.88/cam/realmonitor?channel=1&subtype=0";
const string ipcUrl="rtsp://192.168.1.88:554/av_stream";
const string ipcUser="admin";
const string ipcPassword="admin";
